...
{
    public class C_RegBBDD_Nullable_Int
    {
        ...
        public C_RegBBDD_Nullable_Int()
        {
        }

        public C_RegBBDD_Nullable_Int(int? id, string name, string description, DateTime insertDate, DateTime? updateDate, DateTime? deleteDate)
        {
            this.Id = id;
            this.Name = name;
        ...
        public C_RegBBDD_Nullable_Int(C_RegBBDD_Int r)
        {
            this.Set(r);
        }
